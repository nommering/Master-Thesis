...
if __name__ == '__main__':
    ...
    # Extract y_train for the municipality of Vaals
    municipality_index = data[data.iloc[:, 0] == 'Vaals'].index[0]  # Find the row index for Vaals
    y_train = y_train_init[municipality_index]  # Extract Vaals's data
    ...
    for _ in range(num_runs):
        ...
        random_search.fit(X_train, y_train)  # No need to flatten y_train for fitting
