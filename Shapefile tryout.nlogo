...
to load-data
  ...
  ; Load all datasets
  set wijk-dataset gis:load-dataset "household_coordinates.shp"         ;street code area
  set bouw-dataset gis:load-dataset "household_coordinates.shp"        ;households point shape file
  set geemente-dataset gis:load-dataset "household_coordinates.shp"      ; Dalfsen geemente polygon shape file
  set buurten-dataset gis:load-dataset "household_coordinates.shp"      ; city section polygon shape file
