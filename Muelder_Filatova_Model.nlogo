...
to load_data
  ...
  foreach feature-list [ ?1 ->
    ...
    set roofsizes csv:from-file "combined_b3_opp_dak_schuin_values.csv"
    ...
    create-households 1 [ ;; initialize households
      ...
      let x (1 + (random(100 - 1 + 1)))
        ifelse x < 6 [set income (1 + random (10000 - 1 + 1)) ]
        [ifelse x > 5 and x < 13 [ set income (10000 + random (20000 - 10000 + 1)) ]
        [ifelse x > 12 and x < 23 [ set income (20000 + random (30000 - 20000 + 1)) ]
        [ifelse x > 22 and x < 35 [ set income (30000 + random (40000 - 30000 + 1)) ]
        [ifelse x > 34 and x < 47 [ set income (40000 + random (50000 - 40000 + 1)) ]
        [ifelse x > 46 and x < 59 [ set income (50000 + random (60000 - 50000 + 1)) ]
        [ifelse x > 58 and x < 71 [ set income (60000 + random (70000 - 60000 + 1)) ]
        [ifelse x > 70 and x < 82 [ set income (70000 + random (80000 - 70000 + 1)) ]
        [ifelse x > 81 and x < 92 [ set income (80000 + random (90000 - 80000 + 1)) ]
...
;set pv-no and pv-yes for all utility functions
  ...
  ifelse initial_pv_share > random-float 1 [set pv-init 1 ]
     [set pv-init 0]
...
ifelse income <= 40000 [
  ...
  set roofsizes but-first roofsizes ; remove the header
  set roof-size 80.08 ;item who roofsizes ; set the roof-size variable for each turtle
