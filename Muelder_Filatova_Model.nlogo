...
to load_data
  ...
  foreach feature-list [ ?1 ->
    ...
    set roofsizes csv:from-file "combined_b3_opp_dak_schuin_values_laren.csv"
    ...
    create-households 1 [ ;; initialize households
      ...
      let x (1 + (random(100 - 1 + 1)))
        ifelse x < 8 [set income (1 + random (10000 - 1 + 1)) ]
        [ifelse x > 7 and x < 15 [ set income (10000 + random (20000 - 10000 + 1)) ]
        [ifelse x > 14 and x < 21 [ set income (20000 + random (30000 - 20000 + 1)) ]
        [ifelse x > 20 and x < 27 [ set income (30000 + random (40000 - 30000 + 1)) ]
        [ifelse x > 26 and x < 34 [ set income (40000 + random (50000 - 40000 + 1)) ]
        [ifelse x > 33 and x < 41 [ set income (50000 + random (60000 - 50000 + 1)) ]
        [ifelse x > 40 and x < 48 [ set income (60000 + random (70000 - 60000 + 1)) ]
        [ifelse x > 47 and x < 57 [ set income (70000 + random (80000 - 70000 + 1)) ]
        [ifelse x > 56 and x < 69 [ set income (80000 + random (90000 - 80000 + 1)) ]
