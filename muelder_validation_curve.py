...
if __name__ == '__main__':
    ...
    plt.plot(n_splits_range, cv_scores_mean, color='green', marker='o', markersize=5, label='mean cross-validated error')
    plt.fill_between(n_splits_range, cv_scores_mean - cv_scores_std, cv_scores_mean + cv_scores_std, alpha=0.15, color='green')
